    ...
    <transition name="multiselect">
      ...
      >
        ...
        >
          ...
          <li v-if="multiple && max === internalValue.length">
            <span class="multiselect__option">
              <slot name="maxElements"
                >حد اکثر {{ max }} انتخاب شده است. برای اضافه کردن گزینه جدید یک
                گزینه را حذف کنید
              </slot>
            </span>
          </li>
          ...
          >
            <span class="multiselect__option">
              <slot name="noOptions">لیست خالی است</slot>
            </span>
          </li>
...
import pointerMixin from "@/mixins/pointerMixin.js";
